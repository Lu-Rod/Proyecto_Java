...
public class Main 
{
    public static void main( String[] args )
    {
        ...
        FileHandler<Pregunta> fileHandler = new FileHandler<Pregunta>("C:\\_VScode\\Programación_II\\Proyecto_Java\\pooshowcase\\src\\main\\java\\com\\cerp\\resource\\preguntas.data");
